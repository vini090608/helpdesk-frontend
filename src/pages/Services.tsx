    ...
    return (
        <main className="p-12">
            <div className="flex justify-between">
                ...
                <Button onClick={() => setUpload(true)} className="w-fit h-fit py-3 px-3">
                    <img src={Plus} alt="" />
                    Novo
                </Button>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr className="border-b border-gray-500 last:border-b-0">
                                ...
                                <td className="px-2 py-2">
                                    <Button onClick={() => (setUpload(true), setParam(service.name))} className="bg-gray-500 w-8 h-8">
                                        <img src={Pencil} alt="" />
                                    </Button>
                                </td>
                            </tr>
            ...
            <ServicesModal isOpen={upload} onClose={() => setUpload(false)} Search={param}/>
        </main>
    );
}